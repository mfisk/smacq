...
ThreadedSmacqModule::ThreadedSmacqModule(smacq_init * volatile_context) : SmacqModule(volatile_context) {
  char * stack = (char*)malloc(STACK_SIZE);

  context = (smacq_init*)memdup(volatile_context, sizeof(smacq_init));
