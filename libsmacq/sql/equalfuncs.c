 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/cvs/flow/libsmacq/sql/equalfuncs.c,v 1.1 2002/10/30 17:39:26 wbarber Exp $
 *
 *-------------------------------------------------------------------------
 */
...
_equalParam(Param *a, Param *b)
{
	...
	switch (a->paramkind)
	{
		...
		case PARAM_INVALID:
			...
			break;
		default:
			fprintf(stderr, "_equalParam: Invalid paramkind value: %d",
				 a->paramkind);
	}
...
equal(void *a, void *b)
{
	...
	switch (nodeTag(a))
	{
		...
		default:
			fprintf(stderr, "equal: don't know whether nodes of type %d are equal",
				 nodeTag(a));
			break;
	}
